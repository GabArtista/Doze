<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CriarFormaPagamento.aspx.cs" Inherits="CriarFormaPagamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <div class="container" style="padding: 100px 0;">
        ...
        <div class="card">
            <div class="card-body">
                <form id="CriarFormaPagamentoForm" runat="server">
