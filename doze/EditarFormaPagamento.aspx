<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EditarFormaPagamento.aspx.cs" Inherits="EditarFormaPagamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="container" style="padding: 100px 0;">
        ...
        <div class="card">
            <div class="card-body">
                <form id="EditarFormaPagamentoForm" runat="server">

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Nome</label>
                        <asp:TextBox ID="txtNomeFop" runat="server" placeholder="Novo nome" CssClass="form-control" ClientIDMode="Static" TextMode="SingleLine"></asp:TextBox>
                    ...
                    <div class="mb-3">
                        ...
                        <asp:TextBox ID="txtObservacaoFop" runat="server" placeholder="Nova Observação" CssClass="form-control" ClientIDMode="Static" TextMode="MultiLine"></asp:TextBox>
                    </div>
